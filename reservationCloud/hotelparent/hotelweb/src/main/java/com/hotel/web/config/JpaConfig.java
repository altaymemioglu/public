...
import com.hotel.web.config.JpaConfigProperties;

@Configuration
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {"com.hotel.security.repository"})
@EnableJpaAuditing
public class JpaConfig{
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManager.setPackagesToScan(new String[] { "com.hotel.security.data" }); 
