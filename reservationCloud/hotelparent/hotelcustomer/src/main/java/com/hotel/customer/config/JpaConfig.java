...
@EnableJpaRepositories(basePackages = {"com.hotel.security.repository","com.hotel.customer.repository"})
@EnableJpaAuditing
public class JpaConfig{
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManager.setPackagesToScan(new String[] { "com.hotel.security.data","com.hotel.customer.data"}); 
